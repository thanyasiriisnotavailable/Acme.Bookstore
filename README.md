...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 54b7b9ef-1f57-475d-a57b-20d45c3337aa
```

> `54b7b9ef-1f57-475d-a57b-20d45c3337aa` is the password of the certificate, you can change it to any password you want.
